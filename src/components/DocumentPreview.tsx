...
export const DocumentPreview: React.FC<DocumentProps> = ({
  ...
  return (
    <div
      ...
      className="w-full max-w-[800px] bg-white text-[#1A1A1A] p-4 sm:p-6 relative font-serif text-xs leading-snug rounded shadow-sm border border-slate-200 mx-auto"
    >
